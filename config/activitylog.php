...
return [
     ...
     *
     * Ours refuses updates and deletes: the audit trail is append-only, and
     * that is enforced in the model rather than left to discipline. Corrections
     * are a new entry; expiry is a scheduled job. See decision E3.
     */
    'activity_model' => App\Core\Models\Activity::class,
